...
export default function ResultsPage() {
  ...
  const { results, sourceImage, detectionImages } = state;
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-8">
            <div className="mb-8 p-6 bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl border border-blue-100">
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-3">Source Image</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-3">
                  Detection Images ({detectionImages.length})
                </h3>
                <div className="grid grid-cols-2 gap-3 max-h-64 overflow-y-auto">
                  {detectionImages.map((url, index) => (
